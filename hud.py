    ...
    def draw(self, screen, player, dt, camera  = None ):
        ...
        if keys[pygame.K_h]:
            if not self.h_was_pressed:
                ...
                for i in range (10) : 
                    spawn_local_particle(group = self.particles, pos = (pos_x, pos_y), sprite_path="Ressources/particles/damage.png", chaos = 0 , speed_range= (150, 400), rot = 0 , angles = (0, 360), shrink_range=(12, 40),  size = 7 )
