...
class Game:
    def __init__(self, pCard: PlayerCard, pDeck: Deck, pDiscard: DiscardPile, pHand : Hand, bCard: PlayerCard, bDeck: Deck, bDiscard: DiscardPile, bHand : Hand):
        self.screen = screen
        self.screenSize = self.screen.get_size()
...
if __name__ == "__main__":
    ...
    player = PlayerCard(screen, ((screenSize[0] - (35*3.25))/2, (screenSize[1] - (47*3.25))/1.25))
    decklistP = [Card(screen, "Dmg2"), Card(screen, "HpUp3")]
    deckP = Deck(screen, ((screenSize[0] - (35*3.25))*34/35, (screenSize[1] - (47*3.25))*5.1/7), decklistP)
    discardP = DiscardPile(screen, ((screenSize[0] - (35*3.25))*34/35,(screenSize[1] - (47*3.25))*6.5/7))   
    handP = Hand(screen, ((screenSize[0] - (35*3.25))*9/35,(screenSize[1] - (47*3.25))*1/7))

    boss = PlayerCard(screen, ((screenSize[0] - (35*3.25))/2, (screenSize[1] - (47*3.25))/3.75))
    decklistB = [Card(screen, "Dmg2"), Card(screen, "HpUp3")]
    deckB = Deck(screen, ((screenSize[0] - (35*3.25))*1/35, (screenSize[1] - (47*3.25))*1.9/7), decklistB)
    discardB = DiscardPile(screen, ((screenSize[0] - (35*3.25))*1/35,(screenSize[1] - (47*3.25))*0.5/7))   
    handB = Hand(screen, ((screenSize[0] - (35*3.25))*9/35,(screenSize[1] - (47*3.25))*1/7))
